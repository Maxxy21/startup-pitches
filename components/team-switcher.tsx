                    ...
                    >
                        ...
                        <Dialog>
                            <DialogTrigger asChild>
                                <DropdownMenuItem className="gap-2 p-2 rounded-md focus:bg-primary/10 focus:text-primary" onSelect={(e) => e.preventDefault()}>
                                    <div
                                        className="flex h-7 w-7 items-center justify-center rounded-md border border-dashed border-muted-foreground/70">
